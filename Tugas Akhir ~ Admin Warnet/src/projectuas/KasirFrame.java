...
public class KasirFrame extends JFrame {
    ...
    AdminController kasirLogin = new AdminController();
    ...
    public KasirFrame() {
        ...
        buttonLogin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                for (int i = 0; i < AdminController.index1; i++) {
                    if (nama.equals(AdminController.nama[i]) && pass.equals(AdminController.pass[i])) {
                        ketemu = true;
                    }

                }
                if (ketemu == true) {
                    BayarFrame bayar = new BayarFrame();
                    kasirFrame.dispose();
                } else {
